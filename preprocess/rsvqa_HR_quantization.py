...
traindf = pd.read_csv(os.path.join(data_dir,'traindf.csv'))
valdf = pd.read_csv(os.path.join(data_dir,'valdf.csv'))
testdf = pd.read_csv(os.path.join(data_dir,'testdf.csv'))
...
dfs['train'].to_csv(os.path.join(data_dir, 'traindf.csv'), index=False)
dfs['val'].to_csv(os.path.join(data_dir, 'valdf.csv'), index=False)
dfs['test'].to_csv(os.path.join(data_dir, 'testdf.csv'), index=False)
